...
const Footer = () => {
  ...
  const lastUpdateDate = new Date('2025-07-31').toLocaleDateString('de-DE');
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex items-center">
              ...
              <a href="mailto:fewo@amertens.me" className="hover:text-lake-300 transition-colors">
                fewo@amertens.me
              </a>
            </div>
          </div>
              ...
              <li>
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>Version V1.31 - Datum des letzten Updates: {lastUpdateDate}</p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </li>
